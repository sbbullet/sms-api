...
const filterEmptyFields = (dataObj) => {
    return Object.fromEntries(
        Object.entries(dataObj).filter(([key, value]) => {
            if (value === null || value === undefined) return false; // Remove null or undefined
            if (typeof value === "object" && !Array.isArray(value) && Object.keys(value).length === 0) return false; // Remove empty objects
